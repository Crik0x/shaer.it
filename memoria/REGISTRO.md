...
T-022/C · 2026-07-27c · Wiring fuso del cliente (blocco C di T-022) · fatto, data layer provato (rendering [~]) · pagine leggono profiles.timezone; foglia timezone-sync + server action saveTimezone (auth interna, guardia 'solo se UTC', updated_at); lib/timezone.ts (isValidTimeZone) testata; 23/23 unit + profiles.test C + next build verde; revisore approvato (1 bloccante chiuso + 1 non bloccante risolto)
FONDAZIONE-ECO · 2026-07-28 · Pivot d'ecosistema: doc Shaer.it dall'altezza QR all'ecosistema · fatto (solo documentazione, nessun codice prod) · MD/ ristrutturato (ecosistema/ sopra, modulo-qr/ per i doc QR spostati con git mv); MD/ecosistema/MDD.md v1.3 (14 §, 17 moduli, roadmap a blocchi, decisioni E-D-01…E-D-16); MD/ecosistema/PRD.md v0.1 skeleton (EE1…EE14); aperti T-025/026/027/028; dossier T-025-ecosistema-fondazione. Prova: file in MD/ecosistema/*, git diff --stat
T-027 · 2026-07-28 · Promozione decisioni fondative dell'ecosistema in DECISIONI.md · fatto · E-D-01…E-D-16 [LOCKED] promosse (grep -c '^## E-D-' = 16); visione approvata da Nick, MDD v1.4; hook pre-commit §12 (L-010). Prova: memoria/DECISIONI.md
